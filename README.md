...
|---|---|---|
| Dashboard | Aggregate portfolio metrics, evidence charts, up to five matters needing attention and three recent events; links into filtered directories and individual reviews | Summary only; all counts derive from local sample records |
